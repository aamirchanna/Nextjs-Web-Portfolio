...
const ContactForm = () => {
  ...
  return (
    <div className="bg-[#140c1c] rounded-lg p-4 sm:p-10">
      ...
      Ready to bring your ideas to life? As a designer and web developer, I create stunning visuals and seamless websites. Let’s make something amazing together!
